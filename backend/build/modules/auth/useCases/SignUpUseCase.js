...
let SignUpUseCase = class SignUpUseCase {
    constructor(authRepository, tokenManager, encryptManager) {
    ...
    execute({ name, email, password }) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (foundUser.length > 0) {
                throw new AppError_1.default(userConstants_1.default.ALREADY_REGISTERED, 400);
            }
...
SignUpUseCase = __decorate([
    ...
    __param(1, (0, tsyringe_1.inject)("TokenProvider")),
